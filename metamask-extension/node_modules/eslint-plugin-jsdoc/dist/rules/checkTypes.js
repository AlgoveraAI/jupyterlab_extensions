    ...
    (0, _jsdocTypePrattParser.traverse)(typeAst, (node, parentNode, property) => {
      ...
      if (hasMatchingPreferredType) {
        ...
        for (const strictNativeType of strictNativeTypes) {
          ...
          if (strictNativeType.toLowerCase() === nodeName.toLowerCase() && strictNativeType !== nodeName && (!preferredTypes || (preferredTypes === null || preferredTypes === void 0 ? void 0 : preferredTypes[strictNativeType]) === undefined)) {

...
let EditableText = class EditableText extends AbstractPureComponent2 {
    ...
    render() {
        ...
        return (React.createElement("div", { className: classes, onFocus: this.handleFocus, tabIndex: tabIndex },
            ...
            shouldHideContents ? undefined : (React.createElement("span", Object.assign({}, spanProps, { className: Classes.EDITABLE_TEXT_CONTENT, ref: this.refHandlers.content, style: contentStyle }), hasValue ? value : this.props.placeholder))));
    }
    componentDidMount() {
